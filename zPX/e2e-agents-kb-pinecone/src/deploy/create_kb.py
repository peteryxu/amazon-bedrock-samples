...
def create_knowledgebase(region, account_id ):
    ...
    kb_pinecone_conn='https://datafield-04cb6c7.svc.aped-4627-b74a.pinecone.io'
    pinecone_key_sm_arn=f'arn:aws:secretsmanager:us-east-1:864981754328:secret:pinekey-G6CrvC'
